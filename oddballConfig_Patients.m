% ODDBALL TASK. VERSION: novel oddball task with dynamometors 
%__________________________________________________________________________________

function [maintask, list] = oddballConfig_Patients(opposite_input_on, strength_on, novelty_on, strength, chooseOne, subID, calibTones,calibFiles)
%% Housekeeping
...
trials = 160;%160;%160; %160 %trial number
