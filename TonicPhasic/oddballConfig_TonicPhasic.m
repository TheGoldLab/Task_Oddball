...
function [maintask, list] = oddballConfig_TonicPhasic(opposite_input_on, subID, values, strength,calibTones,calibFiles)
%% Housekeeping
...
interval = 1; %Fixation interval required by eyelink NORMALLY 1   
standardf = 1000; 
oddf = 2000; 
...
% EYELINK  
    ...
    screensize = screensize(2, [3, 4]); % normally 2
...
% required strength)
maxp = 10;%max x points of gauge on screen
nbPoints = 1500;
...
stimList = {'name', 'entry', 'input', 'exit', 'timeout', 'next';
                 ...
                 'Feedback', {}, {checkfunc list}, {}, 0, 'CheckFix';
                 'CheckFix', {@checkFixation list}, {}, {}, 0, '';
