...
% Prepare EEG
label = {'Fz','Fp1','Fp2','Pz','P4','P3','Cz','C4'};
freq  = 250;
 % Info related to EEG
MetaDataOddball();
...
edfdata = edfmex(EDFfilename,'.edf'); % eyetracker file
xdfdata = load_xdf('WhateverNameYouChose.xdf'); % EEG file
